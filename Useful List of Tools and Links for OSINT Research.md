...
- [OSINT Handbook 2018](https://www.i-intelligence.eu/wp-content/uploads/2018/06/OSINT_Handbook_June-2018_Final.pdf) - delighted to share the latest version of our OSINT Tools and Resources Handbook. This version is almost three times the size of the last public release in 2016. It reflects the changing intelligence needs of our clients in both the public and private sector, as well as the many areas we have been active in over the past two years. 
...
- [Verifying Online Information Digital pdf](https://firstdraftnews.org/wp-content/uploads/2019/10/Verifying_Online_Information_Digital_AW.pdf) - Shaydanay Urbani is a writer and research reporter at First Draft, where she covers disinformation and trains journalists internationally in verification and responsible reporting. She has a background in criminal justice reporting, Middle Eastern languages and politics, and food policy, as well as a masters in journalism from The City University of New York.
...
- [github.com: tweetdeck-scraper](https://github.com/matteo-grella/tweetdeck-scraper) - A docker container wrapping a tool to continuously scrape Tweetdeck tweets, store them in ElasticSearch and add scraped ids to a RabbitMQ queue.
- [www.rand.org/content/dam/rand/pubs/research_reports/RR1400/RR1408/RAND_RR1408.pdf](https://www.rand.org/content/dam/rand/pubs/research_reports/RR1400/RR1408/RAND_RR1408.pdf) - The Intelligence Community (IC) is strongly emphasizing the use of structured analytic techniques (SATs) to promote rigorous analysis, lessen the risk of intelligence failure, and make analysts’ reasoning more transparent to consumers
- [Pyschology of Intelligence Analysis pdf](https://www.cia.gov/static/9a5f1162fd0932c29bfed1c030edf4ae/Pyschology-of-Intelligence-Analysis.pdf) -
...
- [Google's Python Class | Python Education | Google Developers](https://developers.google.com/edu/python/) -  this is a free class for people with a little bit of programming experience who want to learn Python.
- [DataJournalism.com](https://datajournalism.com/) - Where journalism meets data
- [Manipulated Media](https://www.reuters.com/manipulatedmedia) - The spread of inaccurate and misleading information is a significant and growing global problem.  It is a major challenge for journalists and a source of alarm for governments, institutions and individuals all over the world.
- [Audio Fakes](https://motherboard.vice.com/en_us/article/3k7mgn/baidu-deep-voice-software-can-clone-anyones-voice-with-just-37-seconds-of-audio) - ‘Deep Voice’ Software Can Clone Anyone's Voice With Just 3.7 Seconds of Audio
- [Magma.lavafeld.org](https://magma.lavafeld.org/) - Your first stop when conducting research on information controls, Internet censorship, and online surveillance.
...
- [Databases (Worldwide) - Investigative Dashboard](https://investigativedashboard.org/databases/) - collection of public data sources compiled by our researchers that are the most useful for investigative reporting.
- [Opengazettes.com](http://opengazettes.com/) - Government gazettes are the notice of record for many key events. For example, a notice about company liquidation will appear in the gazette weeks before appearing on the company register, and will contain information you can’t find elsewhere.
- [OpenCorporates :: The Open Database Of The Corporate World](https://opencorporates.com/) - The largest open database of companies in the world
- [Aleph data search](https://data.occrp.org/) - The global archive of research material for investigative reporting.
- [Overseas registries](https://www.gov.uk/government/publications/overseas-registries/overseas-registries) - Overseas registries
...
- [Companies House UK](https://www.gov.uk/get-information-about-a-company) - Get information about a company
- [Company Check Orbis](https://orbisdirectory.bvdinfo.com/version-20171213/OrbisDirectory/Companies) - Orbis is the world’s most powerful comparable data resource on private companies
- [Company Check Zauba](https://www.zaubacorp.com/) - Zauba Corp helps you know financial performance of businesses you deal with Access critical documents and information for facts based decision making
- [Company Check](https://companycheck.co.uk/) - With advanced searching, free company accounts and comprehensive credit reports across the UK & Ireland, Company Check is the UK's most used online business data provider, delivering over 100 million reports to 21 million visitors in 2018 alone.
- [Financial Conduct Authority](https://register.fca.org.uk/) - In the UK, nearly all financial service activities must be authorised by the Financial Conduct Authority. You can search our Register for firms and individuals and the activities firms have permissions for.
- [The Investigators Handbook: A Guide to Using OpenCorporates](https://blog.opencorporates.com/2017/10/31/the-investigators-handbook-a-guide-to-using-opencorporates/) - The largest open database of companies in the world
- [Business Monitor](https://business-monitor.ch/en) - Business information and company addresses for Switzerland
...
- [The Data Visualisation Catalogue](https://datavizcatalogue.com/) - The Data Visualisation Catalogue is a project developed by Severino Ribecca to create a (non-code-based) library of different information visualisation types. The website serves as a learning and inspiration resource for those working with data visualisation.
- [OSoMe: Social Media Observatory](https://osome.iuni.iu.edu/tools/) - Tools created by the OSoMe team.
- [Dark Web Tools](https://iaca-darkweb-tools.com/) -
- [Deepfakes Club](https://www.deepfakes.club/) - the leading software for creating deepfakes
- [This X does not exist](https://thisxdoesnotexist.com/) - Using generative adversarial networks (GAN), we can learn how to create realistic-looking fake versions of almost anything, as shown by this collection of sites that have sprung up in the past month. Learn how it works.

## Case Studies
- [Victims of Offshore: A Video Introduction to the Panama Papers - ICIJ](https://www.icij.org/investigations/panama-papers/video/) - Behind the email chains, invoices and documents that make up the Panama Papers are often unseen victims of wrongdoing. This is their story.
